    ...
    getWorkspaceFolder(uri) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!Array.isArray(workspaceFolders) || workspaceFolders.length === 0) {
                vscode_1.window.showInformationMessage('Please open a workspace folder');
                return;
            }
            ...
            const folder = yield vscode_1.window.showWorkspaceFolderPick({ placeHolder: 'Select a workspace' });
