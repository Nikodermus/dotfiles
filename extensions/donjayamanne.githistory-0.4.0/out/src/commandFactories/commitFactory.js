...
let CommitCommandFactory = class CommitCommandFactory {
    constructor(branchCreationCommandHandler, cherryPickHandler, compareHandler, revertHandler, viewChangeLogHandler) {
...
CommitCommandFactory = __decorate([
    ...
    __param(3, inversify_1.inject(types_1.IGitRevertCommandHandler)),
    __param(4, inversify_1.inject(types_1.IGitCommitViewDetailsCommandHandler)),
