'use strict';
const locator = require('ruby-method-locate'), minimatch = require('minimatch');
...
function camelCaseRegExp(query) {
    ...
    return new RegExp(`[${prefix.toLowerCase()}${prefix.toUpperCase()}]` +
...
module.exports = class Locate {
    ...
    _parseAsync(absPath, relPath) {
        ...
        if (this.settings.include && !minimatch(relPath, this.settings.include))
            return Promise.resolve();
