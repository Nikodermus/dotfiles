...
let GitBranchFromCommitCommandHandler = class GitBranchFromCommitCommandHandler {
    ...
    createBranchFromCommit(commit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newBranchName = yield this.applicationShell.showInputBox({ placeHolder: msg, prompt: description });
            if (typeof newBranchName !== 'string' || newBranchName.length === 0) {
                return;
            }
            const gitService = this.serviceContainer.get(types_4.IGitServiceFactory).createGitService(commit.workspaceFolder);
