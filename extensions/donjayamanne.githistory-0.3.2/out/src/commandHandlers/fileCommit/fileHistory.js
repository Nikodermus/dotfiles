...
let GitFileHistoryCommandHandler = class GitFileHistoryCommandHandler {
    constructor(serviceContainer, commandManager, applicationShell, fileSystem, documentManager) {
    ...
    viewFile(nodeOrFileCommit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gitService = this.serviceContainer.get(types_5.IGitServiceFactory).createGitService(fileCommit.workspaceFolder);
            if (fileCommit.committedFile.status === types_5.Status.Deleted) {
                return yield this.applicationShell.showErrorMessage('File cannot be viewed as it was deleted').then(() => void 0);
            }
            const uri = yield this.getFileUri(gitService, fileCommit);
            const doc = yield this.documentManager.openTextDocument(uri);
    ...
    compareFileWithWorkspace(nodeOrFileCommit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gitService = this.serviceContainer.get(types_5.IGitServiceFactory).createGitService(fileCommit.workspaceFolder);
            if (fileCommit.committedFile.status === types_5.Status.Deleted) {
                return yield this.applicationShell.showErrorMessage('File cannot be compared with, as it was deleted').then(() => void 0);
            }
            if (!(yield this.fileSystem.fileExistsAsync(fileCommit.committedFile.uri.fsPath))) {
                return yield this.applicationShell.showErrorMessage('Corresponding workspace file does not exist').then(() => void 0);
            }
            ...
            this.commandManager.executeCommand('vscode.diff', tmpFile, fileCommit.committedFile.uri, title, { preview: true });
        });
    }
    compareFileWithPrevious(nodeOrFileCommit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (fileCommit.committedFile.status === types_5.Status.Added) {
                return yield this.applicationShell.showErrorMessage('File cannot be compared with previous, as this is a new file').then(() => void 0);
            }
    ...
    compareFileAcrossCommits(fileCommit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (fileCommit.committedFile.status === types_5.Status.Added) {
                return yield this.applicationShell.showErrorMessage('File cannot be compared, as this is a new file').then(() => void 0);
            }
    ...
    getFileUri(_gitService, fileCommit) {
        return __awaiter(this, void 0, void 0, function* () {
            const args = [
            ...
            return vscode_1.Uri.parse(`${constants_1.gitHistoryFileViewerSchema}://./${fileCommit.committedFile.relativePath}.${fileCommit.logEntry.hash.short}${ext}?${args.join('&')}`);
        });
    }
};
__decorate([
...
GitFileHistoryCommandHandler = __decorate([
    ...
    __param(4, inversify_1.inject(types_1.IDocumentManager)),
