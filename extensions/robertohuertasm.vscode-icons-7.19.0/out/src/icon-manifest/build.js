...
const iconGenerator = new iconGenerator_1.IconGenerator(utils_1.vscode, defaultSchema_1.schema, '', /*avoidCustomDetection*/ true);
const json = iconGenerator.generateJson(supportedExtensions_1.extensions, supportedFolders_1.extensions);
iconGenerator.persist(settings_1.extensionSettings.iconJsonFileName, json, /*updatePackageJson*/ true);
