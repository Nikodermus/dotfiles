...
function generateHeadRefHtmlView(entry) {
    if (entry.headRef)
        return `
            <div class="media-image">
                <div class="commit-head-container">
                    <div class="refs">
                        <span>${he_1.encode(entry.headRef)}</span>
                    </div>
                </div>
            </div>`;
    return ``;
}
exports.generateHeadRefHtmlView = generateHeadRefHtmlView;
function generateRemoteRefHtmlView(entry) {
...
exports.generateRemoteRefHtmlView = generateRemoteRefHtmlView;
