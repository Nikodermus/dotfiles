...
function detectAngular(config, results) {
    ...
    const detectionResult = projectAutoDetection_1.ProjectAutoDetection.checkForAngularProject(presetValue, projectAutoDetection_1.ProjectAutoDetection.iconsDisabled(models_1.Projects.angular), !!projectInfo, i18nManager);
