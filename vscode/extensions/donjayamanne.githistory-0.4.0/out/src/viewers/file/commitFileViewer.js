...
class CommitFileViewerProvider {
    ...
    provideTextDocumentContent(uri, _token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const gitService = this.svcContainer.get(types_1.IGitServiceFactory).createGitService(query.workspaceFolder);
            return gitService.getCommitFileContent(query.hash, vscode_1.Uri.parse(query.fsPath));
        });
    }
}
