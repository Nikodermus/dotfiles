...
let GitHistoryCommandHandler = class GitHistoryCommandHandler {
    ...
    viewHistory(fileUri, lineNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const workspaceFolder = yield uiService.getWorkspaceFolder(fileUri);
            if (!workspaceFolder) {
                return undefined;
            }
            ...
            yield this.serviceContainer.get(types_5.IWorkspaceQueryStateStore).initialize(id, workspaceFolder, branchName, types_6.BranchSelection.Current, '', fileUri, lineNumber);
            const queryArgs = [
