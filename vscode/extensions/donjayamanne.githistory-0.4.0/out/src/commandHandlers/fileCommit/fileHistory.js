...
const mimeTypes_1 = require("../file/mimeTypes");
...
let GitFileHistoryCommandHandler = class GitFileHistoryCommandHandler {
    ...
    viewFile(nodeOrFileCommit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.commandManager.executeCommand('git.openFileInViewer', uri, fileCommit);
        });
    }
    ...
    getFileUri(gitService, fileCommit) {
        return __awaiter(this, void 0, void 0, function* () {
            if (mimeTypes_1.isTextFile(vscode_1.Uri.file(fileCommit.committedFile.uri.fsPath))) {
                const args = [
                ...
                const file = yield gitService.getCommitFile(fileCommit.logEntry.hash.full, fileCommit.committedFile.uri.fsPath);
                return vscode_1.Uri.file(file.fsPath);
            }
        });
    }
};
