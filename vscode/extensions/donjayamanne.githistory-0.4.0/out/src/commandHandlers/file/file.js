...
let FileCommandHandler = class FileCommandHandler {
    ...
    openFile(file, fileCommit) {
        return __awaiter(this, void 0, void 0, function* () {
            const fileUri = vscode_1.Uri.file(fileCommit.committedFile.uri.fsPath);
            if (mimeTypes_1.isTextFile(fileUri)) {
...
__decorate([
    registration_1.command('git.openFileInViewer', types_3.IFileCommandHandler),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [vscode_1.Uri, types_2.FileCommitDetails]),
